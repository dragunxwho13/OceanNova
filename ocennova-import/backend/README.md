...
**🌊 [Try the live demo](https://oceannova.streamlit.app/)** — no install required.
...
Want to just click around without installing anything? Use the
**[live demo](https://oceannova.streamlit.app/)** instead — the steps below
are for running it locally (e.g. to modify the code or use real PACE data).
